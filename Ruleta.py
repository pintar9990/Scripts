...
while final == 1:
    ...
    while terminar == 1:
        ...
        if Hacer == 1:
            print("\nUtiliza puntos en vez de comas para especificar euros\n")
            ...
            while True:
                try:
                    o = int(input(
                        "\nIntroduce \"1\" si tu ruleta admite cantidades inferiores a 1 céntimo,\n"
            ...
            print("\nUtiliza puntos en vez de comas para especificar probabilidad")
            while True:
                try:
